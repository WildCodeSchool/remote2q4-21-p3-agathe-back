...
INSERT INTO products(name, price, characteristic, description, ingredient)
...
INSERT INTO users(id, firstname, password, email, isadmin)
VALUES ( 1, 'admin', 'test', 'admin@example.com', true);
